...
import oxygen from "../../assets/industry/woman-oxyzen.webp"
import img1 from "../../assets/industry/Health-2.webp"
import img2 from "../../assets/industry/Health-5.jpg"
import img3 from "../../assets/industry/Health-4.jpg"
import Dentist2 from "../../assets/industry/Health-3.webp"
        ...
        <>
            <div className="mncrrrd">
                <Helmet>
                    ...
                    <title>Clinical Air Purifiers -Hospital Air Purifier By Mars Purifier</title>
                    <meta name="description" content="Clinical Air Purifiers -The 5-Stage, 6-Stage Filter Hospital Grade Air Purification System Accredited By ISO and Trusted By The NHS." />
                    <link rel="canonical" href="https://marspurifier.com/clinical-air-purifiers-hospital-air-purifier-by-mars-purifier/" />
                    <meta property="og:locale" content="en_GB" />
                    <meta property="og:type" content="article" />
                    <meta property="og:title" content="Clinical Air Purifiers -Hospital Air Purifier By Mars Purifier" />
                    <meta property="og:description" content="Clinical Air Purifiers -The 5-Stage, 6-Stage Filter Hospital Grade Air Purification System Accredited By ISO and Trusted By The NHS." />
                    <meta property="og:url" content="https://marspurifier.com/clinical-air-purifiers-hospital-air-purifier-by-mars-purifier/" />
                    ...
                    <meta property="article:modified_time" content="2022-10-30T20:04:30+00:00" />
                    <meta property="og:image" content="https://marspurifier.com/wp-content/uploads/2021/07/woman-oxyzen.jpg" />
                ...
                <div className="hero-cst">
                    <div className="text-part">
                        ...
                        <h1>Clinical & Hospital Grade Air Purifiers - Trusted By The NHS<br /></h1>
                        <p>Clinical & hospital-grade air purifiers, ISO accredited and trusted by the NHS, dental clinics, and clean rooms worldwide.<br />Learn why Mars Purifier is designed to eliminate viruses meet every tough standard possible – with no exceptions.</p>
                ...
                <div className="scend">
                    ...
                    <div className="text-sec">
                        <div className="desc">
                            <h4>Mars Purifier For Hospitals</h4>
                            <h1>Clinical Air Purification With Purpose.</h1>
                            <div className="imgs-mbl">
                                <img className="ib1" src={img1} alt="" />
                            </div>
                            <p>Our air purification systems are specifically designed to be used in a clinical and medical environment to clean the air and reduce airborne particles from reaching the respiratory tract when treating someone who is suspected or known to be suffering from an infectious disease.<br />With Mars Purifier, you can confidently and consistently eliminate airborne transmission, help save lives and potentially reduce the cost of patient care in your hospital..</p>
                            <div className="imgs-mbl">
                                <img className="ig1" src={img2} alt="" />
                                <img className="ig2" src={img3} alt="" />
                            </div>
                ...
                <div className="thed">
                    <div className="txt">
                        <h2>Mars Makes Clinical Air Purifiers Easy To Understand.</h2>
                        <p>Gain complete transparency on your clinical air purifier with real-time updates on air quality and machine performance.<br />Provide hospital patients and occupants the peace of mind that the air is clean and safe to breathe.</p>
                    </div>
                    <div className="img">
