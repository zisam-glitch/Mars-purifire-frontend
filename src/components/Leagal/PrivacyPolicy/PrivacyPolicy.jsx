        ...
        <>
            ...
            <Helmet>
                ...
                <div className="hero-ss">
                    ...
                    <h3>Introduction</h3>
                    <p>Welcome to the Mars Purifier Limited’s privacy policy.<br /> <br />
                        Mars Purifier Limited respects your privacy and is committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you. </p>
                    <h3>Important Information And Who We Are</h3>
                    <h4>Purpose Of This Privacy Policy</h4>
                    <p>This privacy policy aims to give you information on how Mars Purifier Limited collects and processes your personal data through your use of this website, including any data you may provide through this website when you sign up to our newsletter, purchase a product or service or take part in a competition.<br /> <br />This website is not intended for children and we do not knowingly collect data relating to children.<br /> <br />It is important that you read this privacy policy together with any other privacy policy or fair processing policy we may provide on specific occasions when we are collecting or processing personal data about you so that you are fully aware of how and why we are using your data. This privacy policy supplements other notices and privacy policies and is not intended to override them.</p>
                    <h4>Controller</h4>
                    <p>Mars Purifier Limited is the controller and responsible for your personal data (collectively referred to as “COMPANY”, “we”, “us” or “our” in this privacy policy).<br /> <br />We have appointed a data protection officer (DPO) who is responsible for overseeing questions in relation to this privacy policy. If you have any questions about this privacy policy, including any requests to exercise your legal rights, please contact the DPO using the details set out below.</p>
                    <h4>Contact Details</h4>
                    <p>If you have any questions about this privacy policy or our privacy practices, please contact our DPO in the following ways: <br /> <br />Full name of legal entity: Mars Purifier Limited<br /> <br />Email address: www.marspurifier.com <br /> <br />Postal address: Mars Purifier Ltd, 31 Wollaton Hall Drive, Nottingham, NG8 1AF<br /> <br />You have the right to make a complaint at any time to the Information Commissioner’s Office (ICO), the UK regulator for data protection issues (ico.org.uk). We would, however, appreciate the chance to deal with your concerns before you approach the ICO so please contact us in the first instance.</p>
                    <h4>Changes To The Privacy Policy And Your Duty To Inform Us Of Changes</h4>
                    <p>We keep our privacy policy under regular review. Historic versions can be obtained by contacting us.<br /> <br />It is important that the personal data we hold about you is accurate and current. Please keep us informed if your personal data changes during your relationship with us.</p>
                    ...
                    <div className="mlist">
                        <li><b> Direct interactions. </b> You may give us your Identity, Contact and Financial Data by filling in forms or by corresponding with us by post, phone, email or otherwise. This includes personal data you provide when you:</li>
                        ...
                        <li><b>Third parties or publicly available sources.</b> We will receive personal data about you from various third parties and public sources as set out below:</li>
                    </div>
                    <p>Technical Data from the following parties: <br /> <br />1. Analytics providers such as Google based outside the UK; <br />2. Advertising networks <br /> 3. Search information providers.</p>
                    <div className="mlist">
                    ...
                    <table className="tb">
                        <tbody>
                            <tr valign="top">
                                <td width={222}>
                                    <h5 align="justify"><b>Purpose/Activity</b></h5>
                                </td>
                                <td width={170}>
                                    <h5 align="justify"><b>Type of data</b></h5>
                                </td>
                                <td width={276}>
                                    <h5 align="justify"><b>Lawful basis for processing including basis of legitimate interest</b></h5>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td width={222}>
                                    <h5 align="justify">To register you as a new customer</h5>
                                </td>
                                <td width={170}>
                                    <h5 align="justify">(a) Identity</h5>
                                    <h5 align="justify">(b) Contact</h5>
                                </td>
                                <td width={276}>
                                    <h5 align="justify">Performance of a contract with you</h5>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td width={222}>
                                    <h5 align="justify">To process and deliver your order including:</h5>
                                    <h5 align="justify">(a) Manage payments, fees and charges</h5>
                                    <h5 align="justify">(b) Collect and recover money owed to us</h5>
                                </td>
                                <td width={170}>
                                    <h5 align="justify">(a) Identity</h5>
                                    <h5 align="justify">(b) Contact</h5>
                                    <h5 align="justify">(c) Financial</h5>
                                    <h5 align="justify">(d) Transaction</h5>
                                    <h5 align="justify">(e) Marketing and Communications</h5>
                                </td>
                                <td width={276}>
                                    <h5 align="justify">(a) Performance of a contract with you</h5>
                                    <h5 align="justify">(b) Necessary for our legitimate interests (to recover debts due to us)</h5>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td width={222}>
                                    <h5 align="justify">To manage our relationship with you which will include:</h5>
                                    <h5 align="justify">(a) Notifying you about changes to our terms or privacy policy</h5>
                                    <h5 align="justify">(b) Asking you to leave a review or take a survey</h5>
                                </td>
                                <td width={170}>
                                    <h5 align="justify">(a) Identity</h5>
                                    <h5 align="justify">(b) Contact</h5>
                                    <h5 align="justify">(c) Profile</h5>
                                    <h5 align="justify">(d) Marketing and Communications</h5>
                                </td>
                                <td width={276}>
                                    <h5 align="justify">(a) Performance of a contract with you</h5>
                                    <h5 align="justify">(b) Necessary to comply with a legal obligation</h5>
                                    <h5 align="justify">(c) Necessary for our legitimate interests (to keep our records updated and to study how customers use our products/services)</h5>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td width={222}>
                                    <h5 align="justify">To enable you to partake in a prize draw, competition or complete a survey</h5>
                                </td>
                                <td width={170}>
                                    <h5 align="justify">(a) Identity</h5>
                                    <h5 align="justify">(b) Contact</h5>
                                    <h5 align="justify">(c) Profile</h5>
                                    <h5 align="justify">(d) Usage</h5>
                                    <h5 align="justify">(e) Marketing and Communications</h5>
                                </td>
                                <td width={276}>
                                    <h5 align="justify">(a) Performance of a contract with you</h5>
                                    <h5 align="justify">(b) Necessary for our legitimate interests (to study how customers use our products/services, to develop them and grow our business)</h5>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td width={222}>
                                    <h5 align="justify">To administer and protect our business and this website (including troubleshooting, data analysis, testing, system maintenance, support, reporting and hosting of data)</h5>
                                </td>
                                <td width={170}>
                                    <h5 align="justify">(a) Identity</h5>
                                    <h5 align="justify">(b) Contact</h5>
                                    <h5 align="justify">(c) Technical</h5>
                                </td>
                                <td width={276}>
                                    <h5 align="justify">(a) Necessary for our legitimate interests (for running our business, provision of administration and IT services, network security, to prevent fraud and in the context of a business reorganisation or group restructuring exercise)</h5>
                                    <h5 align="justify">(b) Necessary to comply with a legal obligation</h5>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td width={222}>
                                    <h5 align="justify">To deliver relevant website content and advertisements to you and measure or understand the effectiveness of the advertising we serve to you</h5>
                                </td>
                                <td width={170}>
                                    <h5 align="justify">(a) Identity</h5>
                                    <h5 align="justify">(b) Contact</h5>
                                    ...
                                    <h5 align="justify">(d) Usage</h5>
                                    <h5 align="justify">(e) Marketing and Communications</h5>
                                    <h5 align="justify">(f) Technical</h5>
                                </td>
                                <td width={276}>
                                    <h5 align="justify">Necessary for our legitimate interests (to study how customers use our products/services, to develop them, to grow our business and to inform our marketing strategy)</h5>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td width={222}>
                                    <h5 align="justify">To use data analytics to improve our website, products/services, marketing, customer relationships and experiences</h5>
                                </td>
                                <td width={170}>
                                    <h5 align="justify">(a) Technical</h5>
                                    <h5 align="justify">(b) Usage</h5>
                                </td>
                                <td width={276}>
                                    <h5 align="justify">Necessary for our legitimate interests (to define types of customers for our products and services, to keep our website updated and relevant, to develop our business and to inform our marketing strategy)</h5>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td width={222}>
                                    <h5 align="justify">To make suggestions and recommendations to you about goods or services that may be of interest to you</h5>
                                </td>
                                <td width={170}>
                                    <h5 align="justify">(a) Identity</h5>
                                    <h5 align="justify">(b) Contact</h5>
                                    <h5 align="justify">(c) Technical</h5>
                                    <h5 lang="fr-FR" align="justify">(d) Usage</h5>
                                    <h5 lang="fr-FR" align="justify">(e) Profile</h5>
                                    <h5 lang="fr-FR" align="justify">(f) Marketing and Communications</h5>
                                </td>
                                <td width={276}>
                                    <h5 align="justify">Necessary for our legitimate interests (to develop our products/services and grow our business)</h5>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <h4>Opting Out</h4>
                    <p>You can ask us or third parties to stop sending you marketing messages at any time by contacting us at any time.<br /> <br />Where you opt out of receiving these marketing messages, this will not apply to personal data provided to us as a result of a product/service purchase, warranty registration, product/service experience or other transactions.</p>
                    <h4>Cookies</h4>
                    ...
                    <p>Under certain circumstances, you have rights under data protection laws in relation to your personal data. <br /> <br />If you wish to exercise any of your rights, please contact us.</p>
